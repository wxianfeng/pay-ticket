...
app.get("/verify", function(req, res) {
  ...
  var content = [
    ...
    "Once the payment is confirmed (1 confirmation for Bitcoin, 10 confirmations for Ether), a coupon code will be provided to this E-mail address which can be used to claim the ticket on our event page on the Event Dove http://blockchainweek2016-usd.eventdove.com <br/>",
